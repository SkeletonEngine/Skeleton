...
function(get_git_version VERSION_MAJOR VERSION_MINOR VERSION_PATCH)
  ...
  string(REGEX MATCHALL "v([0-9]+)\\.([0-9]+)" "${LAST_TAG}" MATCH)
  message("${LAST_TAG}")
  if(MATCH)
...
add_custom_command(
  ...
  DEPENDS "${CMAKE_CURRENT_SOURCE_DIR}/include/skeleton/core/version.hpp.in"
  VERBATIM
)

# Define a custom target for the version header
add_custom_target(skeleton-version-header ALL
  DEPENDS "${CMAKE_CURRENT_SOURCE_DIR}/include/skeleton/core/version.hpp"
)
